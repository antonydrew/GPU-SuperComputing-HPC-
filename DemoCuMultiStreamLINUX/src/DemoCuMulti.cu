...
#define PATH "/home/tony/DemoCuMulti/"
...
#define STR 3				//number of streams - use 2 to be safe since most GPU's can handle 2 streams if threads are low on each stream
...
int main(int argc, char **argv){
	...
	int *intperiod,*start_h,*stop_h,c, lens=0, combos=0,counters=0,starto=0,tachy=0,lenny=0,gap=0,gap2=0;
	long *dt;
