...
namespace HTMLReportEngineTestApp
{
	...
	public class Form1 : System.Windows.Forms.Form
	{
		...
		public Form1()
		{
			...
			//
			InitializeComponent();
            cmbConnectionString.Text = "Server=sql.cs.luc.edu;uid=adrew;pwd=p27614;" +
                    "Initial Catalog=adrew";
            txtQuery.Text = "Select * from Table5";
			//
		...
		private void btnExecute_Click(object sender, System.EventArgs e)
		{
			try 
			{
                ...
                connection.ConnectionString = "Server=sql.cs.luc.edu;uid=adrew;pwd=p27614;" +
                "Initial Catalog=adrew";
                connection.Open();

                //connection = new SqlConnection(cmbConnectionString.Text);
                
                SqlDataAdapter adapter = new SqlDataAdapter(txtQuery.Text, cmbConnectionString.Text);
		...
		private void btnGenerateReport_Click(object sender, System.EventArgs e)
		{
			...
			if(res == DialogResult.OK) 
			{
                ...
                //report.OpenReport(saveFileDialog1.FileName);
				this.Cursor = Cursors.Default;
			}
